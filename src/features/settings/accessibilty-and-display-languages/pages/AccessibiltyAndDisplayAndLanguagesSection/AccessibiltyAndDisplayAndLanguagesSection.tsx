...
const AccessibiltyAndDisplayAndLanguagesSection = () => {
  // 언어 설정
  ...
  const tabs = useSettingsTabs("AccessibiltyAndDisplayAndLanguagesSection");
...
export default AccessibiltyAndDisplayAndLanguagesSection;
