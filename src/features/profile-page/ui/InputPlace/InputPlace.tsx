import { selectPlace } from "@shared/@common/models/selectors";
...
import { setPlace } from "@shared/@common/models/slices/userSlice";
...
const InputPlace = ({
  ...
  // 언어 설정
  const { label, error } = useLanguageContent(["profilepage", "InputPlace"]);

  const field = "place";

  const inputValue = useSelector(selectPlace);
