...
interface SelectBirthMonthAndDateVisibilityProps {
  className?: string;
  disabled?: boolean;
...
const SelectBirthMonthAndDateVisibility = ({
  className,
  disabled = false,
  setIsValid,
}: SelectBirthMonthAndDateVisibilityProps) => {
  // 언어 설정
...
export default SelectBirthMonthAndDateVisibility;
