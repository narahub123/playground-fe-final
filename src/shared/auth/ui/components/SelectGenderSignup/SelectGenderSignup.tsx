...
import Select, {
  SelectOptionType,
  useSelect,
} from "@shared/@common/ui/components/Select";
...
interface SelectGenderSignupProps {
...
const SelectGenderSignup = ({
  setIsValid,
  className,
  disabled = false,
}: SelectGenderSignupProps) => {
  // 언어 설정
  ...
  const value = useSelector(getGenderInSignup);
