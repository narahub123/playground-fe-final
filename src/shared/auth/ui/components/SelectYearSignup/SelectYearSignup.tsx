...
interface SelectYearSignupProps {
...
const SelectYearSignup = ({
  setIsValid,
  className,
  disabled = false,
}: SelectYearSignupProps) => {
  // 언어 설정
  ...
  const {
    ...
    data,
    field,
    updateFunc: setBirthYearInSignup,
    setIsValid,
  });
...
export default SelectYearSignup;
